...
@Controller
public class OprOutletController {
	private static Logger logger = Logger.getLogger(OprOutletController.class);
	...
	@RequestMapping(value="/operator/outletList.html", method=RequestMethod.GET)
	public String entityPanel(HttpServletRequest request,Model model) {
	   	logger.debug(":::::::::: inside operator outlet home:::::::::::::::::");
	   	model.addAttribute("routes", adminService.getAllLookUpEntity("Route"));
    	...
    	model.addAttribute("srs", adminService.getEnityList(AdminSearchVo.fetchFromRequest(request),"SR"));
    	...
    	model.addAttribute("distributors", adminService.getEnityList(AdminSearchVo.fetchFromRequest(request),"Distributor"));
	   	...
	   	return "operator/outletList";
	}

	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/operator/activeOutletList.html", method=RequestMethod.GET)
	public @ResponseBody Map entityList(HttpServletRequest request, Map map) {    	
    	List<AbstractBaseEntity> outletList = adminService.getActiveEnityList(AdminSearchVo.fetchFromRequest(request),"Outlet");
