...
@Entity
@Table(name="cy_re_distributor_order")
public class DistributorOrder extends AbstractBaseEntity{
	...
	@Column(name = "distributor_balance")
    ...
    @Transient
    private List<DistributorOrderLi> orderLiList;
    ...
    public DistributorOrder(){
    	...
    	mmApproved = false;
    	mdApproved = false;
    	orderLiList = new ArrayList<DistributorOrderLi>();
    	hasError = false;
    }
	...
	public DistributorDeposit getLastDeposit() {
		return lastDeposit;
	}


	public void setLastDeposit(DistributorDeposit lastDeposit) {
	...
	public List<DistributorOrderLi> getOrderLiList() {
		return orderLiList;
	}

	public void setOrderLiList(List<DistributorOrderLi> orderLiList) {
	...
	public String getEditLink(){
		if(!this.misApproved){
			return "<a href='./distributorOrder.html?id="+super.getId()+"'>edit</a>";
		}else if(this.mdApproved){
			return "<a href='./distributorOrder.html?rd=1&id="+super.getId()+"'>view</a>";			
		}else{
	...
	public String getDeleteLink(){
		if(!this.misApproved){
			return "<a href='javascript:deleteLinkClicked(\"./distributorOrderDelete.html?id="+super.getId()+"&did="+this.distributor.getId()+"\")'>delete</a>";
		}
		return "";
	}
	
	public String getDetailLink(){
		String content = "<a href='./distributorOrder.html?id="+super.getId()+"&rd=1&ap=1&tp=";
		if(!this.misApproved){
