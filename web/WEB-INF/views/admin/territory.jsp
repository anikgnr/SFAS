		...
		<div class="ipsBox table_wrap">
			<div class="ipsBox_container" style="padding: 35px;">		
				<div id="formBlock" style="padding-left: 250px !important;">
					<form:form method="post" action="./saveTerritory.html">
						<form:hidden path="id"/>
						<table style="border-collapse: separate;border-spacing: 5px;">
							<tr>
								<td width="110px;"><spring:message code="rsm.form.region"/> : <span class="required">*</span></td>
								<td>
									<form:select id="regionId" path="area.region.id">
							...
							<tr><td>&nbsp;</td></tr>
							<tr>
								<td width="110px;"><spring:message code="territory.form.name"/> : <span class="required">*</span></td>
