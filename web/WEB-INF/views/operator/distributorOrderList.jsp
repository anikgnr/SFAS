...
<body>	
	...
	<div class="category_block block_wrap" style="width: 1020px;padding-top:20px;padding-left: 100px;">
		<h3 class="maintitle" ><spring:message code="distributor.order.list.title"/> of ${distributorName}</h3>
		<div class="ipsBox table_wrap">
			<div class="ipsBox_container" style="padding: 35px;">		
				...
				<center>
					...
					<input class="button orange" id="createDistributorOrder" type="button" value='<spring:message code="depo.order.form.new"/>'/>
				</center>			
			</div>
		</div>
	</div>	  
