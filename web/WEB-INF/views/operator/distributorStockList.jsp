...
<body>	
	...
	<div class="category_block block_wrap" style="width: 1020px;padding-top:20px;padding-left: 100px;">
		<h3 class="maintitle"><spring:message code="current.stock.form.title"/> of ${distributorName}</h3>
		<div class="ipsBox table_wrap">
			<div class="ipsBox_container" style="padding: 35px;">		
					...
					<table cellspacing="10" cellpadding="0">
						<tr>
							...
							<td  style="text-aling: right;">
								<input class="button orange" name="reset" type="reset" value='<spring:message code="login.button.reset"/>'/>&nbsp;<input class="button orange" id="stockSearchBtn" type="button" value='<spring:message code="search.button.title"/>'/>
							</td>
						</tr>						
					</table>
					</form>
				...
				<br/><br/><br/>
				<div id="admin-stock-grid" style="padding-left: 65px;"></div><br/>						
				<center>
